...
////STUDENT CODE
//Using unique pointers to replace raw ones
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename) {
        ...
        while (getline(file, lineStr)) {
            ...
            if (type != tokens.end()) {
                ...
                if (idToken != tokens.end()) {
                    ...
                    if (type->second == "NODE") {
                      ////STUDENT CODE
                      //Replacing raw pointer vector with unique pointer vector
  ...
  ////
    ...
    // add pointer to chatlogic so that chatbot answers can be passed to the GUI
